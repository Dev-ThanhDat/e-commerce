...
const CheckOut = () => {
  ...
  const onSubmit = async (data) => {
    const { firstname, lastname, address, city, phone } = data;
        ...
        <div className='flex flex-col order-2 gap-5 shadow-lg p-5 bg-white rounded-lg lg:order-1 w-full lg:w-[60%]'>
          ...
          >
            ...
            <div className='flex flex-col items-center justify-between gap-5 lg:flex-row '>
              ...
              {/* <Link
              to='/'
              className='transition-all lg:max-w-[200px] w-full text-center font-bold bg-color-232f3e hover:bg-opacity-80 py-[8px] px-[15px] text-white rounded-full'
            >
